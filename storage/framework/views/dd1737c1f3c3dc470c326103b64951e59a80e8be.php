    ...
    <ul class="navbar-nav ml-auto">
      <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            <a href="<?php echo e(route('customer_changepassword')); ?>" class="dropdown-item">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item">
            <a href="<?php echo e(route('customer_dashboard')); ?>" class="nav-link">
              <i class="nav-icon fas fa-tachometer-alt"></i>
              <p>Dashboard</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo e(route('customer_duebills')); ?>" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?php echo e(route('customer_payhistory')); ?>" class="nav-link">
...
<?php /**PATH E:\class\versity project for students\electribill\resources\views/layouts/customer_layout.blade.php ENDPATH**/ ?>
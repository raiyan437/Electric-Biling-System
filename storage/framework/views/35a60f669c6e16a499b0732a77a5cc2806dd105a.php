...
<section class="content">
    <div class="container-fluid">
        <div class="card p-3">
            <form method="POST" action="<?php echo e(route('admin_saveconnection')); ?>">
                <?php echo csrf_field(); ?>
                <div class="row">
...
<?php echo $__env->make('layouts.admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\class\versity project for students\electribill\resources\views/admin/newconnection.blade.php ENDPATH**/ ?>
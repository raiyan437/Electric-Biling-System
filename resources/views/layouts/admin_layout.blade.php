    ...
    <ul class="navbar-nav ml-auto">
      <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            <a href="{{ route('admin_changepassword') }}" class="dropdown-item">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ route('admin_billentry') }}" class="nav-link {{ Request::routeIs('admin_billentry') ? 'active' : '' }}">
          ...
          <li class="nav-item">
            <a href="{{ route('admin_duebills') }}" class="nav-link {{ Request::routeIs('admin_duebills') ? 'active' : '' }}">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Due Bills
              </p>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('admin_newconnection') }}" class="nav-link {{ Request::routeIs('admin_newconnection') ? 'active' : '' }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>New Connection</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('admin_connectionlist') }}" class="nav-link {{ Request::routeIs('admin_connectionlist') ? 'active' : '' }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Connection List</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('admin_payrequests') }}" class="nav-link {{ Request::routeIs('admin_payrequests') ? 'active' : '' }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Payment Requests</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('admin_payhistory') }}" class="nav-link {{ Request::routeIs('admin_payhistory') ? 'active' : '' }}">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Payment History</p>
                </a>
              </li>
